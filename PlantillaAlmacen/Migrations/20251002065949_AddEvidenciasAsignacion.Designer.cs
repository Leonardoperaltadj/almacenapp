...
namespace PlantillaAlmacen.Migrations
{
    ...
    [Migration("20251002065949_AddEvidenciasAsignacion")]
    partial class AddEvidenciasAsignacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlantillaAlmacen.Models.Asignacion", b =>
                {
                    ...
                    b.Property<string>("ArchivoAsignacion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ArchivoDanios")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PlantillaAlmacen.Models.EvidenciaAsignacion", b =>
                {
                    ...
                    b.ToTable("EvidenciaAsignacion", (string)null);
                });

            modelBuilder.Entity("PlantillaAlmacen.Models.Factura", b =>
                {
                    b.Property<int>("IdFactura")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlantillaAlmacen.Models.ArticuloComunicaciones", b =>
                {
                    b.HasBaseType("PlantillaAlmacen.Models.Articulo");
                    ...
                    b.HasDiscriminator().HasValue("Comunicaciones");
                });
            ...
            modelBuilder.Entity("PlantillaAlmacen.Models.ArticuloHerramienta", b =>
                {
                    ...
                    b.ToTable("Articulos", t =>
                        {
                            t.Property("Marca")
                                .HasColumnName("ArticuloHerramienta_Marca");

                            t.Property("Modelo")
                                .HasColumnName("ArticuloHerramienta_Modelo");

                            t.Property("NumeroSerie")
                                .HasColumnName("ArticuloHerramienta_NumeroSerie");
                        });
            ...
            modelBuilder.Entity("PlantillaAlmacen.Models.Articulo", b =>
                {
                    ...
                    b.HasOne("PlantillaAlmacen.Models.Factura", "Factura")
                        .WithMany("Articulos")
